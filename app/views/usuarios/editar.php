<div class="d-flex align-items-center justify-content-between mb-3">
  <h5 class="mb-0">Editar usuario #<?= View::e((string)$id) ?></h5>
...
<form method="post" action="<?= View::e(BASE_URL) ?>/index.php?r=usuarios/editar&id=<?= View::e((string)$id) ?>">
  <?php
    // Para editar: personasTodas (permitimos reasignar si lo deseas)
